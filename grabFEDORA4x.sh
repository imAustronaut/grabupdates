...
echo alias grabdwnlupd="git clone --depth 1 https://github.com/imAustronaut/grabupdates/blob/main/grabFEDORA4x.sh" >> ~/.config/grabmngr/config.grab
echo alias grabdwnlupd="git clone --depth 1 https://github.com/imAustronaut/grabupdates/blob/main/grabFEDORA4x.sh" >> ~/.zshrc
